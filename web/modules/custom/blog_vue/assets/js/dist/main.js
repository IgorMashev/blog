(function (Vue$1) {
          ...
          _c(
            ...
            [
              _c("input", {
                ...
                attrs: { type: "text", autocomplete: "off", placeholder: "Search" },
                on: {
    ...
    __vue_render__._withStripped = true;
      ...
      const __vue_inject_styles__ = function (inject) {
        if (!inject) return
        inject("data-v-30fc7515_0", { source: ".frontpage-global-search[data-v-30fc7515] {\n  position: relative;\n}\n.frontpage-global-search__search-input[data-v-30fc7515] {\n    padding: 16px !important;\n    border-radius: 4px 0 0 4px !important;\n}\n.frontpage-global-search__search-submit[data-v-30fc7515] {\n    color: white;\n    background-color: #3f5efb;\n    background-image: none;\n    border-color: transparent;\n    transition: all .15s ease-in-out;\n    box-shadow: 0 1px 1px rgba(0, 0, 0, 0.125);\n    border-radius: 0 4px 4px 0;\n    padding: 0 32px;\n    text-transform: uppercase;\n    font-weight: bold;\n}\n.frontpage-global-search__form[data-v-30fc7515] {\n    position: relative;\n    z-index: 50;\n    display: flex;\n    box-shadow: 0 0 50px rgba(0, 0, 0, 0.2);\n}\n.frontpage-global-search__form--has-results[data-v-30fc7515] {\n    box-shadow: none;\n}\n.frontpage-global-search__results[data-v-30fc7515] {\n    position: absolute;\n    z-index: 40;\n    top: 54px;\n    width: 100%;\n    background-color: white;\n    border: 1px solid #cccccc;\n    border-radius: 0 0 4px 4px;\n    box-shadow: 0 0 50px rgba(0, 0, 0, 0.2);\n}\n.frontpage-global-search__result[data-v-30fc7515] {\n    padding: 8px 16px;\n    border-bottom: 1px solid #cccccc;\n}\n.frontpage-global-search__result[data-v-30fc7515]:hover {\n      background-color: #3f5efb;\n}\n.frontpage-global-search__result:hover a[data-v-30fc7515] {\n        color: white;\n}\n.frontpage-global-search__result[data-v-30fc7515]:last-child {\n      border-bottom: unset;\n}\n@media (max-width: 751px) {\n.frontpage-global-search__search-submit[data-v-30fc7515] {\n      padding: 0 8px;\n      font-size: 18px;\n      width: 130px;\n}\n}\n\n/*# sourceMappingURL=FrontpageGlobalSearch.vue.map */", map: {"version":3,"sources":["/var/www/blog/web/modules/custom/blog_vue/assets/js/src/components/FrontpageGlobalSearch.vue","FrontpageGlobalSearch.vue"],"names":[],"mappings":"AAyEA;EACA,kBAAA;AAAA;AAEA;IACA,wBAAA;IACA,qCAAA;AAAA;AAGA;IACA,YAAA;IACA,yBAAA;IACA,sBAAA;IACA,yBAAA;IACA,gCAAA;IACA,0CAAA;IACA,0BAAA;IACA,eAAA;IACA,yBAAA;IACA,iBAAA;AAAA;AAGA;IACA,kBAAA;IACA,WAAA;IACA,aAAA;IACA,uCAAA;AAAA;AAGA;IACA,gBAAA;AAAA;AAGA;IACA,kBAAA;IACA,WAAA;IACA,SAAA;IACA,WAAA;IACA,uBAAA;IACA,yBAAA;IACA,0BAAA;IACA,uCAAA;AAAA;AAGA;IACA,iBAAA;IACA,gCAAA;AAAA;AAFA;MAKA,yBAAA;AAAA;AALA;QAQA,YAAA;AAAA;AARA;MAaA,oBAAA;AAAA;AAIA;AACA;MACA,cAAA;MACA,eAAA;MACA,YAAA;AAAA;AACA;;AC3FA,oDAAoD","file":"FrontpageGlobalSearch.vue","sourcesContent":["<template>\n  <div class=\"frontpage-global-search\" v-click-outside=\"onClickOutside\">\n    <div class=\"frontpage-global-search__form\"\n         :class=\"{ 'frontpage-global-search__form--has-results': searchResults.length}\">\n      <input type=\"text\"\n             autocomplete=\"off\"\n             class=\"frontpage-global-search__search-input\"\n             placeholder=\"Search\"\n             @input=\"onTextInput\"\n             @focus=\"onTextFocus\"\n             @keypress.enter=\"onButtonClick\">\n      <button class=\"frontpage-global-search__search-submit\"\n              @click=\"onButtonClick\">Search\n      </button>\n    </div>\n\n    <div class=\"frontpage-global-search__results\"\n         v-if=\"searchResults.length && !resultsHidden\">\n      <div v-for=\"value in searchResults\"\n           class=\"frontpage-global-search__result\">\n        <a :href=\"value.url\">{{value.label}}</a>\n      </div>\n    </div>\n  </div>\n</template>\n\n<script>\n  import debounce from 'lodash-es/debounce';\n\n  export default {\n    data() {\n      return {\n        text: '',\n        searchResults: {},\n        resultsHidden: false,\n      };\n    },\n\n    watch: {\n      text(newValue, oldValue) {\n        if (newValue.length > 2) {\n          this.$store.dispatch('api/doSearchGlobal', newValue)\n            .then(result => this.searchResults = result.items);\n        }\n        else {\n          this.searchResults = {};\n        }\n      },\n    },\n\n    methods: {\n      onTextInput: debounce(function(e) {\n        this.text = e.target.value;\n      }, 300),\n\n      onTextFocus: function(e) {\n        this.resultsHidden = false;\n      },\n\n      onButtonClick: function() {\n        let url = new URL('/search', window.location.origin);\n        url.searchParams.append('text', this.text);\n        window.location.href = url.href;\n      },\n\n      onClickOutside: function(event) {\n        this.resultsHidden = true;\n      },\n    },\n  };\n</script>\n\n<style lang=\"scss\" scoped>\n  .frontpage-global-search {\n    position: relative;\n\n    &__search-input {\n      padding: 16px !important;\n      border-radius: 4px 0 0 4px !important;\n    }\n\n    &__search-submit {\n      color: white;\n      background-color: #3f5efb;\n      background-image: none;\n      border-color: transparent;\n      transition: all .15s ease-in-out;\n      box-shadow: 0 1px 1px rgba(0, 0, 0, 0.125);\n      border-radius: 0 4px 4px 0;\n      padding: 0 32px;\n      text-transform: uppercase;\n      font-weight: bold;\n    }\n\n    &__form {\n      position: relative;\n      z-index: 50;\n      display: flex;\n      box-shadow: 0 0 50px rgba(0, 0, 0, 0.2);\n    }\n\n    &__form--has-results {\n      box-shadow: none;\n    }\n\n    &__results {\n      position: absolute;\n      z-index: 40;\n      top: 54px;\n      width: 100%;\n      background-color: white;\n      border: 1px solid #cccccc;\n      border-radius: 0 0 4px 4px;\n      box-shadow: 0 0 50px rgba(0, 0, 0, 0.2);\n    }\n\n    &__result {\n      padding: 8px 16px;\n      border-bottom: 1px solid #cccccc;\n\n      &:hover {\n        background-color: #3f5efb;\n\n        a {\n          color: white;\n        }\n      }\n\n      &:last-child {\n        border-bottom: unset;\n      }\n    }\n\n    @media (max-width: 751px) {\n      &__search-submit {\n        padding: 0 8px;\n        font-size: 18px;\n        width: 130px;\n      }\n    }\n  }\n</style>",".frontpage-global-search {\n  position: relative; }\n  .frontpage-global-search__search-input {\n    padding: 16px !important;\n    border-radius: 4px 0 0 4px !important; }\n  .frontpage-global-search__search-submit {\n    color: white;\n    background-color: #3f5efb;\n    background-image: none;\n    border-color: transparent;\n    transition: all .15s ease-in-out;\n    box-shadow: 0 1px 1px rgba(0, 0, 0, 0.125);\n    border-radius: 0 4px 4px 0;\n    padding: 0 32px;\n    text-transform: uppercase;\n    font-weight: bold; }\n  .frontpage-global-search__form {\n    position: relative;\n    z-index: 50;\n    display: flex;\n    box-shadow: 0 0 50px rgba(0, 0, 0, 0.2); }\n  .frontpage-global-search__form--has-results {\n    box-shadow: none; }\n  .frontpage-global-search__results {\n    position: absolute;\n    z-index: 40;\n    top: 54px;\n    width: 100%;\n    background-color: white;\n    border: 1px solid #cccccc;\n    border-radius: 0 0 4px 4px;\n    box-shadow: 0 0 50px rgba(0, 0, 0, 0.2); }\n  .frontpage-global-search__result {\n    padding: 8px 16px;\n    border-bottom: 1px solid #cccccc; }\n    .frontpage-global-search__result:hover {\n      background-color: #3f5efb; }\n      .frontpage-global-search__result:hover a {\n        color: white; }\n    .frontpage-global-search__result:last-child {\n      border-bottom: unset; }\n  @media (max-width: 751px) {\n    .frontpage-global-search__search-submit {\n      padding: 0 8px;\n      font-size: 18px;\n      width: 130px; } }\n\n/*# sourceMappingURL=FrontpageGlobalSearch.vue.map */"]}, media: undefined });

      };
      /* scoped */
      const __vue_scope_id__ = "data-v-30fc7515";
      /* module identifier */
      ...
      var FrontpageGlobalSearch = normalizeComponent_1(
